    ...
    <nav className='pt-10 pb-4 border-b border-black'>
      <Container>
        <Flex className="items-center">
          ...
          <div className='flex items-center justify-between bg-[#F5F5F5] py-2 px-3 w-60'>


            <input  type="text" placeholder='What are you looking for'className='placeholder:text-xs placeholder:text-[#00000080] outline-none'/>
